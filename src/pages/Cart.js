...
const Cart = () => {
  ...
  return (
   ...
   <div className=" flex max-w-7xl justify-between mx-auto p-4  ">
  {posts.length > 0 ? (
    <>
      {/* Cart Items */}
      ...
      {/* Summary Section */}
      <div className="mt-1 bg-gray-100 p-6 rounded-lg shadow-md flex flex-col gap-36 justify-between items-center">
        <div>
